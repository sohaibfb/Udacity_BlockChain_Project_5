...
it('can add the star name and star symbol properly', async() => {
    ...
    await instance.createStar('Star2', tokenId2, {from: accounts[0]});
   
    //2. Call the name and symbol properties in your Smart Contract and compare with the name and symbol provided

    assert.equal(await instance.Name.call(), 'My Token');
    assert.equal(await instance.Symbol.call(), 'SOH');
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo(tokenId),'Star1');
});